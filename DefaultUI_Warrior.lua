...
f:SetScript("OnEvent", function(self, event, ...)
  ...
  -- Config/Panel
  if not DefaultUI_Warrior_Config then
    local DefaultUI_Warrior_Config = {}
  end
  -- Color Init
...
local dialogFrameTexture 		= "Interface\\Addons\\DefaultUI_Warrior\\textures\\extra\\dialogFrameTexture"
...
AbyssUISave:SetScript("OnEvent", function(self, event, arg1)
	if (event == "ADDON_LOADED" and arg1 == "DefaultUI_Warrior") then
